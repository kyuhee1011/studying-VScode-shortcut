...
Object.keys(types).map(function (type) {
  ...
  template[type] = function (content) {
    var line = colors[_specs.blockBg[0]][_specs.blockBg[1]](block(_specs.initial)) + " " + content;
    if (typeof content !== 'string') {
      line = colors[_specs.blockBg[0]][_specs.blockBg[1]](block(_specs.initial)) + " " + content.message;
      if (content.type == 'title') {
        line = colors[_specs.blockBg[0]][_specs.blockBg[1]](block(content.name)) + " " + colors[_specs.titleColor](content.message);
      }
